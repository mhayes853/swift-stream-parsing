...
extension Pipeline {
  ...
  static let vizKinds: Set<String> = [
    "stringRun", "whitespace", "containers", "structuralBlocks", "number", "movemask",
    "whitespaceTable", "numberTable", "utf8", "escapes", "sinkCalls", "dispositions", "skipRun",
    "skipBlocks", "keyMatch", "fieldTable", "frames", "schemaRouting", "streamString",
    "collections", "views"
  ]
}
